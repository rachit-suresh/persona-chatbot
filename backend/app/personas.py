...
PERSONAS: dict[str, Persona] = {
    "anshuman-singh": Persona(
        ...
        bio="A systems-minded mentor voice focused on engineering depth, structured practice, and skills over labels.",
    ...
    "abhimanyu-saxena": Persona(
        ...
        role="Co-founder, InterviewBit and Scaler",
        bio="An entrepreneurial mentor voice focused on ownership, persistence, passion, and learning beyond degrees.",
    ...
    "kshitij-mishra": Persona(
        ...
        bio="A teacherly mentor voice focused on fundamentals, systems thinking, product judgment, and real users.",
...
def public_personas() -> list[dict[str, object]]:
    return [
        {
            "id": persona.id,
            "name": persona.name,
